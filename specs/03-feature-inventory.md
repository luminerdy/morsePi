...
| F-24 | Supervised Chromium kiosk with automatic recovery, intentional adult exit, and remote status reporting | V1 | `morse-station-browser.service`, installer, station status |
