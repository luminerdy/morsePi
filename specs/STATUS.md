...
| Student progress sync design and attempt IDs | 2026-08-03 working tree | FR-054, DR-019 — new Practice/Words/Sprint attempts include stable `attempt_id`; merge contract documented; upload/download merge intentionally not enabled yet |
...
| FR-054/DR-019 student progress sync | 🟡 | Merge strategy documented and new attempts get `attempt_id`; actual cloud attempt upload/download and rebuild flow remain future work |
