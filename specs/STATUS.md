...
| Warm-Up Review | main `1d374d2`; release/pi `9c62f70` | FR-059/AC-035 — Daily offers a 10-signal active-letter review after 3+ days away, Practice menu provides a manual Warm-Up button, shows letter plus Morse pattern, rotates learned letters after a readable success pause, keeps reviewing after the 10-signal goal, logs timing/effort attempts, leaves mastery/unlocks/Daily count unchanged, and keeps Learning Now higher priority. Pappy deployed successfully after rollback-protected update attempts, then passed 232 Pi tests and health check. |
