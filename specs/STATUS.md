...
| AC-036 idle Morse screensaver | — | 🟡 | 241 automated tests, 800x480 browser rehearsal, and prior live keyer/touch wake checks pass; a Pi-only dark Morse-mark rendering defect was reproduced and corrected with explicit cyan marks, with live hotfix verification pending |
