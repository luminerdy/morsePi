...
| Message Word Bank and word-level draft editing | 2026-08-10 working tree | FR-041/FR-042/AC-015 — composer links to a scrollable shared Word Bank, draft words are selectable, and selected words can be replaced, removed, or moved without clearing the draft. Key-to-send validation remains the next slice. |
