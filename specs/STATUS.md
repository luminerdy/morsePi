...
| AC-035 Warm-Up Review | — | ✅ | Route tests cover stale-practice recommendation, manual Practice-menu entry point, visible Morse review prompt, self-paced advancement, 10-signal completion, review-only attempt logging, and unchanged mastery progress; Pappy release suite passed 232 tests |
