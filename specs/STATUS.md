...
| Truthful hardened updater and IoT verification | 2026-08-29 working tree | FR-035/FR-058/API-027/AC-031/TEST-019 — update lock, preserved dirty patch, nonzero blocked/rollback results, commit verification, sanitized cloud/Admin status, and read-only remote diagnostics implemented after Astrid/Liara exposed a false-success dirty-checkout skip |
...
| AC-031 remote update Jobs | — | 🟡 | Fake Jobs tests cover success, missing/blocked reports, expected-commit mismatch, fixed diagnostics, and unknown actions. Live Astrid/Liara testing exposed and now covers the old false-success case; live hardened deployment remains pending |
