...
- PIN-gated Pappy Family Activity history for station check-ins, confirmed updates, progress uploads, and message delivery milestones
...
- Silent idle Morse recall screensaver after 3 minutes: Morse-only for 5 seconds, then a 3-second answer reveal, with wake-only touchscreen and physical-keyer input
...
- Supervised Chromium kiosk with automatic crash recovery and update-time refresh
...
- Signal Drop Send/Read game using only each student's active letters, with duplicate clearing, adaptive speed, touch/keyer input, and review feedback
...
- [Family activity and station confirmations](docs/FAMILY_ACTIVITY.md)
